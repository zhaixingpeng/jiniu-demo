...
public class NacosPropertySourceLocator implements PropertySourceLocator {
    ...
    private static final Logger log = LoggerFactory
            .getLogger(com.alibaba.cloud.nacos.client.NacosPropertySourceLocator.class);
...
/**
     * recommend to use
     * {@link com.alibaba.cloud.nacos.client.NacosPropertySourceLocator#NacosPropertySourceLocator(com.alibaba.cloud.nacos.NacosConfigManager)}.
    ...
    public PropertySource<?> locate(Environment env) {
        ...
        EncryptablePropertyFilter defaultLazyPropertyFilter = beanFactory.getBean("lazyEncryptablePropertyFilter", EncryptablePropertyFilter.class);

        return EncryptablePropertySourceConverter.makeEncryptable(InterceptionMode.PROXY, propertyResolver, defaultLazyPropertyFilter,composite);
